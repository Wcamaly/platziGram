...
test('Like image', (() => {
  var _ref4 = _asyncToGenerator(function* (t) {
    ...
    let result = yield db.likeImage(creted.public_id);
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/ProjectNode/platziGram/platziGram-db/test/db-test.js', 133), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\60f69c9cb470cfaa1ec8973c576f48c6.js.map