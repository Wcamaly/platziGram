...
var _asyncToGenerator2 = require('C:\\ProjectNode\\platziGram\\plaziGram-api\\node_modules\\babel-runtime\\helpers\\asyncToGenerator.js');
...
(0, _ava2.default)('GET /:id', (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.deepEqual(_rec._expr(_rec._capt(body, 'arguments/0'), {
      content: 't.deepEqual(body, { id })',
      filepath: 'test\\picture-test.js',
      line: 18,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"body","range":[12,16]},{"type":"ObjectExpression","properties":[{"type":"ObjectProperty","key":{"type":"Identifier","name":"id","range":[20,22]},"value":{"type":"Identifier","name":"id","range":[20,22]},"computed":false,"shorthand":true,"range":[20,22]}],"range":[18,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"body","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"{"},"range":[18,19]},{"type":{"label":"name"},"value":"id","range":[20,22]},{"type":{"label":"}"},"range":[23,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec2._expr(_rec2._capt({ id: id }, 'arguments/1'), {
      content: 't.deepEqual(body, { id })',
      filepath: 'test\\picture-test.js',
      line: 18,
      async: true,
...
//# sourceMappingURL=..\node_modules\.cache\ava\d50057004f7dc5eeb044c2ff04e6054d.js.map